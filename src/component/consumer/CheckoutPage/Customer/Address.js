...
const CurrAddr = (props) => {
  ...
  const AddrSelected = () => {
    history("/checkout", { state: { isAddrSelected: flag } });
    setFlag(!flag);
  };
          ...
          <AddressContainer type="button" className="row py-3">
            ...
            <div className="col">
              <div className="row row-cols-1">
                ...
                <AddressText>
                  <div className="col text-left text-capitalize">
                    {props.addr.flatNo}, {props.addr.address}, {props.addr.city}
                    , <br />
                    Landmark - {props.addr.landmark}, <br />
                    Pincode - {props.addr.pincode}, {props.addr.place_name}
                  </div>
                  <div className="col mb-3 text-left text-capitalize">
                    {props.addr.type} Address
                  </div>
                </AddressText>
...
const Address = () => {
  ...
  useEffect(() => {
    ...
    JSON.parse(localStorage.getItem("CustomerCurrentLoc"));
    setAddr(JSON.parse(localStorage.getItem("CustomerCurrentLoc")));
  }, [state]);

  const AddrSelected = () => {
    history("/checkout", { state: !isAddrSelected });
  };
                    ...
                    <AddressContainer type="button" className="row py-3">
                      ...
                      <div className="col">
                        <div className="row row-cols-1">
                          ...
                          <AddressText>
                            <div className="col text-left text-capitalize">
                              {addr.flatNo}, {addr.address}, {addr.city}, <br />
                              Landmark - {addr.landmark}, <br />
                              Pincode - {addr.pincode}, {addr.place_name}
                            </div>
                            <div className="col mb-3 text-left text-capitalize">
                              {addr.type} Address
                            </div>
