...
import Login from "../../container/Landing Page/Customer/LoginDrawer";
...
function Header() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("role") === "customer") {
      ...
      setPlaceName("Swiggy Partner");
    else if (localStorage.getItem("role") === "agent")
      setPlaceName("Delivery Agent");
    else {
      if (localStorage.getItem("Coordinates") == null) {
        setPlaceName("India");
      } else {
      ...
      <div className="row">
          ...
          <div className="logo-container-fluid">
            <ul className="list-inline">
              <li className="list-inline-item">
                <Link to="/" type="button" className="btn btn-lg">
                  <SVG
                    viewBox="0 0 16 25"
                    height="49"
                    width="34"
        ...
        <div className="col-lg-6">
          <div className="container">
            <nav className="d-flex" style={{ float: "right" }}>
              {name ? (
                <>
